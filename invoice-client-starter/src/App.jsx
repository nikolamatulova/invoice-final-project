...
import IssuedInvoices from "./invoices/IssuedInvoice";
import ReceivedInvoices from "./invoices/ReceivedInvoice";
    ...
    <Router>
      <div className="container">
        ...
        <Routes>
          ...
          <Route path="/invoices/issued/:identificationNumber" element={<IssuedInvoices />} />
          <Route path="/invoices/received/:identificationNumber" element={<ReceivedInvoices />} />
